<script>
  ...
  export let phoneNumber = "1234567890"; // Replace with the actual phone number
  export let displayName = "Trey"; // Optional: Name to display in the link text
  let svgElement;
  let phoneDiv;
  ...
  function togglePhoneVisibility() {
    ...
    phoneDiv.style.display = isPhoneVisible ? "block" : "none";
  }
...
<div class="phone-component">
  <svg
    ...
    on:click={togglePhoneVisibility}
    on:keydown={togglePhoneVisibility}
    fill="#1C2033"
    width="52"
    height="52"
    version="1.1"
  ...
  <div class="phone" bind:this={phoneDiv} style="display: none;">
    <a class="font-header" href={telLink}>Call me? ({displayName})</a>
    <button on:click={() => copy(`${phoneNumber}`)}> 📋 </button>
